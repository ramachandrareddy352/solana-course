...
// 2) upload metadata for the collection
// 3) create the collection for NFT's
// 4) upload metadata for the NFT
// 5) create NFT in that collection
// 6) upload metadata of updated NFT
// 7) update the metadata of that NFT
  ...
  const { nft } = await metaplex.nfts().create(
    {
      ...
      symbol: nftData.symbol,
      collection: collectionMint,  // creating a nft in collection
    },
